...
class MPV:
    ...
    def loadfile(
        self, file: str, audio_file: str | None = None, sub_file: str | None = None
    ) -> None: ...
    ...
    def _set_property(
        self, name: str, value: str | int | dict[str, Any] | list[Any] | set[Any]
    ) -> None: ...
    def wait_until_playing(self, timeout: int | None = None, catch_errors: bool = True) -> None: ...
    def seek(self, amount: int | float, reference: str) -> None: ...
