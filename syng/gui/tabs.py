...
class SourceTab(OptionFrame):
    """Widget for source configuration.
    ...
    def __init__(self, parent: QWidget, config: SourceConfig) -> None:
        """Initialize the widget, creates rows for each option in config.
...
class UIConfigTab(OptionFrame):
    """Configuration widget for the UI settings."""
    ...
    def __init__(self, parent: QWidget, config: UIConfig) -> None:
        ...
        Rows are added by hand and not (yet) autogenerated.

        Args:
            parent: Qt-Parent Object
            config: config to access and store the values
...
class GeneralConfigTab(OptionFrame):
    ...
    def __init__(
        ...
        Rows are added by hand and not (yet) autogenerated.
        If configuration states, that advanced options should not be shown, hides those.
